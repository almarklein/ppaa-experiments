...
performing a complete edge search. This makes it suitable for scientific
visualizations such as plots. Furthermore, it introduces optimizations that
allow it to outperform FXAA.
\end{abstract}
