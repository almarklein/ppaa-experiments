...
When other circles in the image are examined (not shown in Figure~\ref{fig:compare8_circles}) it can be seen that some circles are not diffused by any of the PPAA methods. This is because
