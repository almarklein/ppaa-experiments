// WGSL conversion of DLAA shader
// Original shader by facepuncherfromrussia, updated by ForserX
// Converted to wgsl using ChatGPT, and adjusted for this framework.
